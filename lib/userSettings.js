	...
	Plugin.addProfileInfo = function(profileInfo, callback) {
		...
		console.log('Profile User Settings', username);
			...
			profileInfo.profile.push({
				content: "<span class='tipping-link'><a href='reddcoin:" + address + "?label=Tip%20To%20" + username + "' title='Tip " + username + " with Reddcoin'><img src='" + nconf.get('url') + "/images/rdd_icon.png'> Tip " + username + "</a></span>"
			});
		});
